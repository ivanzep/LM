...
| Jams | Three sections: Open / Proposed / Past (all collapsible), availability voting, optional start/end time. A Duration (hr) field in the add/edit form auto-fills End Time from Start Time (supports quarter-hour fractions and wraps past midnight); typing an End Time directly still works and isn't overwritten unless Start Time or Duration changes again |
